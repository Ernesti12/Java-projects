/*
Group 3 Final Project in comprog2
LEADER: OMAMBAK    JIMCARRY
* ECOJEDO    JOHN FRANCIS
* CABRISOS    JERALDINE
* TALINGTING    RHYLYN
 */
import java.io.*;
...
public class Main {
    ...
    public static void menu() {
        ...
        System.out.println("======================================================");
        System.out.println("*           Aosmec Square Hotel Mini-System          *");
        System.out.println("======================================================");
        ...
        do {
            ...
            //This will convert the input value to lowercase. this will help avoid case sensitive issues.
        ...
        while (!(choice.equalsIgnoreCase("v") || choice.equalsIgnoreCase("a") ||
                choice.equalsIgnoreCase("e") || choice.equalsIgnoreCase("d") ||
                choice.equalsIgnoreCase("f") || choice.equalsIgnoreCase("s") ||
                choice.equalsIgnoreCase("l") || choice.equalsIgnoreCase("o") ||
    ...
    private static void viewRooms() {
        ...
        while (roomNumber < 10) {
            for (int x = 0; x < 10; x++) {
                ...
                if (!(hotel[x].equals("e"))) {
                    System.out.println("Room No. " + x + " is occupied by Mr./Mrs." + hotel[x]);
        ...
        do {
            ...
            try {
                ...
                if (!(hotel[roomNumber].equals("e"))) {
                    ...
                    System.out.println("This room is occupied by: Mr./Mrs. " + hotel[roomNumber]);
                    System.out.println("");
    ...
    private static void alphabeticalOrder() {
        ...
        for (int x = 0; x < names.length; x++) {
            if (!(names[x].equals("e"))) {
                ...
                System.out.println("Mr./Mrs. " + names[x] + " is staying in room No. " + index);
            }
